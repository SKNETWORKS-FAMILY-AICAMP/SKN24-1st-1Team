...
test_data = {
    'CTY_NM': ['경상남도', '경상북도', '전라남도', '전라북도', '충청남도', '충청북도', '강원도', '경기도', '세종특별자치시', '울산광역시', '대전광역시', '광주광역시', '인천광역시', '대구광역시', '부산광역시', '서울특별시'],
    'ACDNT_NOCS': [6001, 10000, 13334, 20001, 26667, 33334, 40000, 46667, 53334, 60000, 66667, 73334, 80000, 86667, 93334, 99999]
}
...
columns=["CTY_NM", "ACDNT_NOCS"], # Pandas 데이터프레임에서 사용할 두 개의 열을 지정 (첫 번째 열: 지역 이름 (GeoJSON과 연결할 키) / 두 번째 열: 수치 데이터 (색상으로 표현될 값))
